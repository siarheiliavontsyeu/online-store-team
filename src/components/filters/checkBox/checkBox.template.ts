import { CheckBoxFilterI } from '../../../constants/types';

const getCheckboxFilter = ({ group, initData, currentData }: CheckBoxFilterI): string => {
...
export const getTemplate = ({ group, initData, currentData }: CheckBoxFilterI): string => {
  return `
