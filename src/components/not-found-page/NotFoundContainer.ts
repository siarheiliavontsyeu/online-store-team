...
type ComponentsClasses = typeof Header | typeof NotFound | typeof Footer;
type ComponentsInstances = Header | NotFound | Footer;
...
export class NotFoundPageContainer {
  ...
  constructor(public store: Store) {
    this.componentsClass = [Header, NotFound, Footer];
  ...
  render() {
    const $root = createNode({ tag: 'div', classes: ['not-found-page', 'd-flex', 'flex-column', 'min-vh-100'] });
